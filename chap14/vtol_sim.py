...
controller = F_vtol.ControllerSSIDO(separate_integrator=False)
...
d_force = P.mixer @ np.array([0.0, 0.0]) # 1 N force, 0.1 N*m torque disturbance
...
viz = F_vtol.Visualizer(time, x_hist, u_hist, r_hist, xhat_hist, d_hist, dhat_hist)
viz.plot()
