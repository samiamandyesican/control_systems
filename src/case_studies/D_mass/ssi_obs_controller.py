...
class MassSSIOController(common.ControllerBase):
    def __init__(self, separate_integrator=True):
        ...
        self.observer = Observer(P.A, P.B, P.Cm, des_obs_poles, P.ts, self.x_eq, self.u_eq)
...
if __name__ == "__main__":
    a = MassSSIOController(separate_integrator=False)