...
class HummingbirdControllerPID(common.ControllerBase):
    ...
    def update_with_measurement(self, r, y):
        ...
        F_tilde = self.kp_th * error_th - self.kd_th * self.thetadot_hat + self.ki_th * self.error_integral[0]

        phi_ref = error_psi * self.kp_psi - self.kd_psi * self.psidot_hat + self.ki_psi * self.error_integral[1]
        r[0] = phi_ref
